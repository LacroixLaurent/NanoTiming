...
f4a <- ggplot(toplot,aes(x=filename,y=seqlen,fill=mut))+
	...
	stat_pointinterval(
		...
		interval_size_range = c(0.1, 0.15))+	geom_text(data=totext,aes(x=filename,y=1100,label=med),col="red",size=2) +
...
quartz(file=path2fig %+% "FigS15-19_A4.pdf",height=10.24,width=7.05,type="pdf")
plWT_all
plRIF1_all
plKU70_all
plCTF19_all
...
quartz(file=paste0(path2fig,"Fig4_A4.pdf"),height=10.24,width=6.14,type="pdf")
plA4
dev.off()
