...
plS4 <- ggcorrplot(cormat1,lab=T,lab_size=4,digits=3)+
	scale_fill_gradient2(limit=c(0,1),low="blue",high="red",mid="white",midpoint=0.5)+
	ggtitle("Figure S4",subtitle="Spearman's rank correlation coefficients")

quartz(file=paste0(path2fig,"FigS4.pdf"),height=14,width=10,type="pdf")
plS4
dev.off()
...
plS11a <- ggcorrplot(cormat1,lab=T,lab_size=4,digits=3)+
	scale_fill_gradient2(limit=c(0,1),low="blue",high="red",mid="white",midpoint=0.5)+
...
cormat1 <- sapply(3:6, function(i) sapply((3:6), function(j) cor(tocor[,i],tocor[,j],use="pairwise.complete.obs",method="s")))
colnames(cormat1) <- rownames(cormat1) <- names(tocor)[3:6]
plS11b <- ggcorrplot(cormat1,lab=T,lab_size=4,digits=3)+
	scale_fill_gradient2(limit=c(0,1),low="blue",high="red",mid="white",midpoint=0.5)+
	ggtitle("Spearman's rank correlation coefficients")

quartz(file=paste0(path2fig,"FigS11.pdf"),height=6,width=12,type="pdf")
plS11a + plS11b + plot_annotation(tag_levels = 'a',title="Figure S11") + plot_layout(guides="collect")
dev.off()
...
quartz(file=paste0(path2fig,"FigS3.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
...
quartz(file=paste0(path2fig,"FigS1.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
...
quartz(file=paste0(path2fig,"FigS2.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
...
quartz(file=paste0(path2fig,"FigS9.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
...
quartz(file=paste0(path2fig,"FigS10.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
...
quartz(file=paste0(path2fig,"FigS5.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
...
quartz(file=paste0(path2fig,"FigS6.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
...
quartz(file=paste0(path2fig,"FigS7.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
...
quartz(file=paste0(path2fig,"FigS8.pdf"),height=14,width=12,type="pdf")
pl
dev.off()
