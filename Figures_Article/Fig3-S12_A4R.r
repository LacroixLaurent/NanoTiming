...
f3a <- ggplot(toplot2,aes(x=TeloName,y=nanoT,col=mut))+
	...
	geom_point(position=position_dodge(width=0.75),alpha=0.5,shape=16,size=0.7)+
...
#	scale_size_manual(values = c("0.5" = 2, "0.95" =0.7))+
...
quartz(file=paste0(path2fig,"Fig3_A4R.pdf"),width=7.05,height=3.85,type="pdf")
plA4
dev.off()
