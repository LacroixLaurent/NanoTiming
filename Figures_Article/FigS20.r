...
saveRDS(tocor,file=path2data %+% "Data_FigS20a.rds")
...
saveRDS(bigres2,file=path2data %+% "Data_FigS20b.rds")

pcomb <- p1+p2 + plot_annotation(tag_levels="a",title="Figure S20") + plot_layout(axis_titles="collect")
ggsave(plot=pcomb,file=path2fig %+% "FigS20.pdf",height=4,width=10)
