...
ggsave(plot=pl,file=paste0(path2fig,"FigS22.pdf"),height=14,width=12)
...
ggcorrplot(cormat1,lab=T,lab_size=4,digits=3)+
	...
	ggtitle("Figure S23",subtitle="Spearman's rank correlation coefficients")
ggsave(path2fig %+% "FigS23.pdf",height=20,width=20)
